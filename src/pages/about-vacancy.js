...
import styles from '@/styles/pages/AboutVacancy.module.scss'
import Avatar from '@mui/material/Avatar'
import LayoutMain from '@/components/layouts/main'
import { Tabs, Tab, Card } from '@mui/material'
import { CustomTab, CustomTabs } from '@/components/tabs'
import React from 'react'
import CompanyDetail from '@/components/about-vacancy/company-detail'
import VacancyDetail from '@/components/about-vacancy/vacancy-detail'
